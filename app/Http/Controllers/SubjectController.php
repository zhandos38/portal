...
class SubjectController extends AppBaseController
{
    ...
    {
        $subjects = $this->subjectRepository->paginate(30);
    ...
    public function store(CreateSubjectRequest $request)
    {
        ...
        Flash::success('Дисциплина успешно создана!');
    ...
    public function show($id)
    {
        ...
        if (empty($subject)) {
            Flash::error('Дисциплина не найдена!');
    ...
    public function update($id, UpdateSubjectRequest $request)
    {
        ...
        Flash::success('Дисциплина успешно обновлена!');
    ...
    public function destroy($id)
    {
        ...
        Flash::success('Дисциплина успешно удалена!');
