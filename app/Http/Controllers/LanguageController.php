...
class LanguageController extends AppBaseController
{
    ...
    public function store(CreateLanguageRequest $request)
    {
        ...
        Flash::success('Язык обучения успешно создан!');
    ...
    public function show($id)
    {
        ...
        if (empty($language)) {
            Flash::error('Язык обучения не найден!');
    ...
    public function update($id, UpdateLanguageRequest $request)
    {
        ...
        Flash::success('Язык обучения успешно обновлена!');
    ...
    public function destroy($id)
    {
        ...
        if(!in_array($id,$arr)){
            ...
            Flash::success('Язык обучения успешно удален!');
        }
        else{
            Flash::error('Запрещено удалять системные параметры');
        }
